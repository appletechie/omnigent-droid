...
from omnigent.community.harness.droid.inner.droid_executor import DroidExecutor
...
def test_inline_text_file_data_variants() -> None:
    from omnigent.community.harness.droid.inner.droid_executor import _inline_text_file_data
